...
export default function Switch({setValue, header, checked}) {
  const divStyle = {
    flexDirection: 'row',
    marginTop: 10,
    minHeight: 30,
  ...
  return (
    <div class="form-check form-switch" style={divStyle}>
      <input style={inputStyle} class="form-check-input" type="checkbox" onChange={() => setValue(!checked)} checked={checked} />
